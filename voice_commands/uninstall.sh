...
if [ -f  ~/.gnome2/nautilus-scripts/"Comandos de Voz" ]
then
rm ~/.gnome2/nautilus-scripts/"Comandos de Voz"
fi
if [ -f ~/.local/share/nautilus/scripts/"Comandos de Voz" ]
then
rm ~/.local/share/nautilus/scripts/"Comandos de Voz"
fi
if [ -d ~/.voice_commands ]
then
